...
const HeaderS = (props) => {
    ...
    return (
        <div>
            ...
            <button className=" menu-btn" onClick={marksClick}> צפיה בציונים   </button>
            <button className=" menu-btn" onClick={hwClick}> תרגילים שהוגשו   </button>
            <button className=" menu-btn" onClick={scheduleClick}>  מערכת שעות   </button>
            <button className=" menu-btn" onClick={testClick}>  מבחנים  </button>
            <button className=" menu-btn"  onClick={enterLessonClick}>  כניסה לשיעור  </button>
